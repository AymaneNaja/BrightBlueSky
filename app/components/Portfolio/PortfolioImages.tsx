...
export function PortfolioImages({
    ...
    return <div className=" w-full sm:w-11/12 md:w-11/12 lg:w-11/12 xl:w-11/12 mx-auto  gap-1 sm:gap-2 md:gap-2 lg:gap-1 xl:gap-4 columns-1 sm:columns-2 md:columns-3 lg:columns-4 xl:columns-5 mt-10  ">
        <div className="w-full flex justify-center items-center flex-wrap gap-3 ">{isLoading && !isSuccess ? picArray.map(num => { return <div key={num} className=" bg-slate-300 animate-pulse rounded-xl w-10/12 sm:w-10/12 md:w-full lg:w-full xl:w-full h-[400px] sm:h-[400px] md:h-[400px] lg:h-[400px] xl:h-[400px]  p-2" /> }) : null}</div>
